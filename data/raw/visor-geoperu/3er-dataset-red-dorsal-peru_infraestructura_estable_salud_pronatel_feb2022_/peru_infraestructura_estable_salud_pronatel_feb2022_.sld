<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>sld_peru_infraestructura_estable_salud_pronatel_feb2022</Name>
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          <Name>OPERATIVO</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>cod_est</ogc:PropertyName>
          ...
          <PointSymbolizer>
             <Graphic>
               <Mark>
                 ...
                 <Fill>
                   <CssParameter name="fill">#2e75b6</CssParameter>
                 </Fill>
                  <Stroke>
                    <CssParameter name="stroke">#203864</CssParameter>
           ...
           <PointSymbolizer>
             <Graphic>
               <Mark>
                 <WellKnownName>circle</WellKnownName>
                 <Fill>
                   <CssParameter name="fill">#bdd7ee</CssParameter>
                 </Fill>
                  <Stroke>
                    <CssParameter name="stroke">#203864</CssParameter>
                    <CssParameter name="stroke-width">1.00</CssParameter>
   ...
   <MaxScaleDenominator>300000</MaxScaleDenominator>
        <TextSymbolizer>
<Label><ogc:PropertyName>nom_est_sl</ogc:PropertyName></Label>
<Font>
...
<Fill>
<CssParameter name="fill">#203864</CssParameter>
</Fill>
